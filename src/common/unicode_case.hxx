...
//
// Unicode 16.0.0 case mappings. `simple*` is the 1:1 mapping a Char
// uses; `expand*` holds only the codepoints whose FULL mapping is
// longer than one codepoint (ß -> SS), which a String uses on top of
// the simple table. See the generator for how the two were sourced.
#include <cstdint>
