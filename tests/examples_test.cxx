...
int main() {
    describe("Examples — All Parse", []() {
        ...
        it("dimensions_advanced.kex", []() { assertTrue(parseFile("examples/dimensions_advanced.kex")); });
    ...
    describe("Examples — All Run", []() {
        ...
        it("regexes.kex", []() { assertTrue(runFileOk("examples/regexes.kex")); });
        ...
        it("dimensions_advanced.kex", []() {
            assertEqual(runFile("examples/dimensions_advanced.kex"),
                         "true\n-1\n-2\n1\nfalse\n");
        });
        ...
        it("template_stdlib.kex", []() {
            ...
            assertTrue(output.find("TemplateParam { name: title, type: String }") != std::string::npos, output);
            assertTrue(output.find("TemplateParam { name: draft, type: Bool }") != std::string::npos, output);
            assertTrue(output.find("TemplateParam { name: tags, type: [String] }") != std::string::npos, output);
    ...
    describe("Examples — Run (stdlib_demo.kex)", []() {
        it("list operations work", []() {
            ...
            // Optional implements Showable: an interpolated Just shows the
            // value alone, None shows nothing.
